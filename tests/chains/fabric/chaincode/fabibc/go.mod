...
require (
	...
	github.com/hyperledger-labs/yui-corda-ibc/go v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/hyperledger-labs/yui-corda-ibc/go => github.com/siburu/yui-corda-ibc/go v0.0.0-20210806171828-af0affefe12d
