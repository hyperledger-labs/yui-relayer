...
type ProverConfig struct {
	FinalityDelay int64 `protobuf:"varint,1,opt,name=finality_delay,json=finalityDelay,proto3" json:"finality_delay,omitempty"`
}
...
var fileDescriptor_a75943d2e3c08b58 = []byte{
	...
	0x0a, 0xc8, 0x34, 0x09, 0x46, 0x05, 0x46, 0x0d, 0xe6, 0x20, 0x5e, 0x98, 0xa8, 0x0b, 0x48, 0xd0,
	...
	0xd4, 0xc5, 0xe6, 0xa3, 0x24, 0x36, 0xb0, 0x8b, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xd0,
	0x69, 0x8e, 0x82, 0xf0, 0x00, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FinalityDelay |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
