...
type StrategyI interface {
	...
	// SortUnrelayedPackets sorts given RelayPackets and returns sorted RelayPackets. Note that input Packet object may be modified.
	SortUnrelayedPackets(ctx context.Context, src, dst *ProvableChain, sh SyncHeaders, rp *RelayPackets) (*RelayPackets, error)
