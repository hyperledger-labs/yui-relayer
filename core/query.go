...
func QueryClientStatePair(
	srcCtx, dstCtx QueryProofContext,
...
func QueryChannelPair(srcCtx, dstCtx QueryProofContext, src, dst IBCProvableQuerierI) (srcChan, dstChan *chantypes.QueryChannelResponse, err error) {
	var eg = new(errgroup.Group)
	eg.Go(func() error {
