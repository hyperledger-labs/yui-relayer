...
type StrategyI interface {
	...
	RelayPackets(dir string, ctx context.Context, relayFrom, relayTo *ProvableChain, packets PacketInfoList, sh SyncHeaders, doExecuteRelay bool) ([]sdk.Msg, error)
	...
	RelayAcknowledgements(dir string, ctx context.Context, relayFrom, relayTo *ProvableChain, packets PacketInfoList, sh SyncHeaders, doExecuteAck bool) ([]sdk.Msg, error)
	...
	UpdateClients(dir string, ctx context.Context, relayFrom, relayTo *ProvableChain, doExecuteRelay, doExecuteAck bool, sh SyncHeaders, doRefresh bool) ([]sdk.Msg, error)
